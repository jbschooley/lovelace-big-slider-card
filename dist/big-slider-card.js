...
}, ne = { example_light: "Example Light" }, f = {
...
}, ce = { example_light: "Beispiellampe" }, le = {
	name: "Big Slider Card",
...
}, he = { example_light: "Luz de ejemplo" }, ge = {
	name: "Big Slider Card",
...
}, Ie = { example_light: "Voorbeeldlamp" }, Le = {
	name: "Big Slider Card",
...
}, m = { example_light: "Przykładowe światło" }, h = {
	name: "Big Slider Card",
...
}, y = { example_light: "Luz de exemplo" }, We = {
	name: "Big Slider Card",
...
}, Xe = { example_light: "Lumină exemplu" }, Ze = {
	name: "Big Slider Card",
...
var S = globalThis, C = S.ShadowRoot && (S.ShadyCSS === void 0 || S.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, w = Symbol(), $e = /* @__PURE__ */ new WeakMap(), et = class {
	constructor(e, t, n) {
...
}, tt = (e) => new et(typeof e == "string" ? e : e + "", void 0, w), nt = (e, ...t) => new et(e.length === 1 ? e[0] : t.reduce((t, n, r) => t + ((e) => {
	if (!0 === e._$cssResult$) return e.cssText;
	if (typeof e == "number") return e;
	throw Error("Value passed to 'css' function must be a 'css' function result: " + e + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
})(n) + e[r + 1], e[0]), e, w), rt = (e, t) => {
...
}, it = C ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((e) => {
	let t = "";
	for (let n of e.cssRules) t += n.cssText;
	return tt(t);
})(e) : e, { is: at, defineProperty: ot, getOwnPropertyDescriptor: st, getOwnPropertyNames: ct, getOwnPropertySymbols: lt, getPrototypeOf: ut } = Object, T = globalThis, dt = T.trustedTypes, ft = dt ? dt.emptyScript : "", pt = T.reactiveElementPolyfillSupport, E = (e, t) => e, D = {
	toAttribute(e, t) {
		switch (t) {
			case Boolean:
				e = e ? ft : null;
...
var k = class extends HTMLElement {
	...
	static getPropertyDescriptor(e, t, n) {
		let { get: r, set: i } = st(this.prototype, e) ?? {
			get() {
				return this[t];
			},
			set(e) {
	...
	static finalize() {
		...
		if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(E("properties"))) {
			let e = this.properties, t = [...ct(e), ...lt(e)];
...
k.elementStyles = [], k.shadowRootOptions = { mode: "open" }, k[E("elementProperties")] = /* @__PURE__ */ new Map(), k[E("finalized")] = /* @__PURE__ */ new Map(), pt?.({ ReactiveElement: k }), (T.reactiveElementVersions ??= []).push("2.1.2");
//#endregion
...
function _t(e) {
	return (t, n) => typeof n == "object" ? gt(e, t, n) : ((e, t, n) => {
...
var j = globalThis, vt = (e) => e, M = j.trustedTypes, yt = M ? M.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, bt = "$lit$", N = `lit$${Math.random().toFixed(9).slice(2)}$`, xt = "?" + N, St = `<${xt}>`, P = document, F = () => P.createComment(""), I = (e) => e === null || typeof e != "object" && typeof e != "function", L = Array.isArray, Ct = (e) => L(e) || typeof e?.[Symbol.iterator] == "function", R = "[ 	\n\f\r]", z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, wt = /-->/g, Tt = />/g, B = RegExp(`>|${R}(?:([^\\s"'>=/]+)(${R}*=${R}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), Et = /'/g, Dt = /"/g, Ot = /^(?:script|style|textarea|title)$/i, V = ((e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}))(1), H = Symbol.for("lit-noChange"), U = Symbol.for("lit-nothing"), kt = /* @__PURE__ */ new WeakMap(), W = P.createTreeWalker(P, 129);
function At(e, t) {
...
var jt = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === z ? c[1] === "!--" ? o = wt : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = B) : (Ot.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = B) : o = Tt : o === B ? c[0] === ">" ? (o = i ?? z, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? B : c[3] === "\"" ? Dt : Et) : o === Dt || o === Et ? o = B : o === wt || o === Tt ? o = z : (o = B, i = void 0);
		let d = o === B && e[t + 1].startsWith("/>") ? " " : "";
		a += o === z ? n + St : l >= 0 ? (r.push(s), n.slice(0, l) + bt + n.slice(l) + N + d) : n + N + (l === -2 ? t : d);
	}
	...
	constructor({ strings: t, _$litType$: n }, r) {
		...
		for (; (i = W.nextNode()) !== null && c.length < s;) {
			if (i.nodeType === 1) {
				if (i.hasAttributes()) for (let e of i.getAttributeNames()) if (e.endsWith(bt)) {
...
var Mt = class {
	...
	_$AI(e, t = this) {
		e = K(this, e, t), I(e) ? e === U || e == null || e === "" ? (this._$AH !== U && this._$AR(), this._$AH = U) : e !== this._$AH && e !== H && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? Ct(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
...
}, Lt = j.litHtmlPolyfillSupport;
Lt?.(G, q), (j.litHtmlVersions ??= []).push("3.3.3");
var Rt = (e, t, n) => {
...
var $ = class extends Z {
	...
	static getConfigForm() {
		return {
					...
					schema: [
						...
						},
						{
							...
							selector: { select: {
								...
								options: [{
									value: "fill",
									label: x("editor.slider_modes.fill")
								}, {
									value: "cursor",
									label: x("editor.slider_modes.cursor")
								}]
							} }
						},
						{
			...
			computeLabel: (e, t) => ({
				...
				slider_mode: x("editor.labels.slider_mode"),
				gradient: x("editor.labels.gradient"),
	...
	setConfig(e) {
		...
		if (t && !c.includes(t)) throw Error(x("errors.unsupported_domain"));
